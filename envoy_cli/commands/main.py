...
from envoy_cli.commands.default_cmd import default
...
from envoy_cli.commands.flag_cmd import flag
...
cli.add_command(cmd_encrypt, "encrypt")
cli.add_command(cmd_decrypt, "decrypt")
cli.add_command(sync)
cli.add_command(profile)
cli.add_command(diff)
cli.add_command(audit)
cli.add_command(export)
cli.add_command(cmd_import_profile, "import")

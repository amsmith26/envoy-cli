...
Registers all sub-command groups and provides the top-level `envoy` command.
"""
...
@click.group()
@click.version_option(version=VERSION, prog_name="envoy")
def cli():
    """envoy — Manage and sync .env files across projects and environments securely."""
    pass
...
cli.add_command(env_set, name="set")
